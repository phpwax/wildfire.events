...
WaxEvent::add(CONTENT_MODEL.".setup", function(){
  ...
  $obj->define("event_date_start", "DateTimeField", array('group'=>'event', 'label'=>'Event start','output_format'=>"j F Y H:i",'input_format'=>"j F Y H:i", 'default'=>date("Y-m-d") ));
  $obj->define("event_date_end", "DateTimeField", array('group'=>'event', 'label'=>'Event end','output_format'=>"j F Y H:i",'input_format'=>"j F Y H:i", 'default'=>date("Y-m-d",mktime(0,0,0, date("m"), date("j")+10, date("y") )) ));
